...
//! [15]
void EditorMainWindow::documentWasModified()
//! [15] //! [16]
{
...
//!
  ...
  QAction *aboutAct =
      helpMenu->addAction(tr("&About"), this, &EditorMainWindow::about);
...
//! [40]
bool EditorMainWindow::maybeSave()
//! [40] //! [41]
{
...
//! [42]
void EditorMainWindow::loadFile(const QString &fileName)
//! [42] //! [43]
{
  QFile file(fileName);
...
//! [44]
bool EditorMainWindow::saveFile(const QString &fileName)
//! [44] //! [45]
{
  QFile file(fileName);
...
//! [46]
void EditorMainWindow::setCurrentFile(const QString &fileName)
//! [46] //! [47]
{
  curFile = fileName;
...
//! [48]
QString EditorMainWindow::strippedName(const QString &fullFileName)
//! [48] //! [49]
{
...
//! [49]
#ifndef QT_NO_SESSIONMANAGER
void EditorMainWindow::commitData(QSessionManager &manager) {
