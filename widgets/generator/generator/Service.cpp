...
Service::Service(const std::vector<std::string> &controllers, const std::string &arguments) : controllers(controllers), arguments(arguments) {}
Service::~Service() {}
...
void Service::createFilterHeaderFile(std::ofstream &file, const std::string &className, const std::string &fileName, const std::string &content)
{
...
*/
  ...
  {
    file << "/*inh*/\n";
    auto find = find_section_in_string(content, R"(/\*inh\*/)", R"(/\*inh_end\*/)");
    file << find;
    file << "/*inh_end*/\n";
  }
  file << "{\n";
...
void Service::createSourceFile(std::ofstream &file, const std::string &className, const std::string &fileName, const std::string &content)
{
